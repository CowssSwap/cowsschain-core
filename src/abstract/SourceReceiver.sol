...
abstract contract SourceReceiver is IEscrowSource, Owned {
    ...
    function isCorrectSender(uint256 chainId, address sender) internal view returns(bool) {
    ...
    function setSenderForChainId(uint256 chainId, address sender) external onlyOwner {
